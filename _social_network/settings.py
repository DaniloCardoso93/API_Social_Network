"""
Django settings for _social_network project.
...
ALLOWED_HOSTS = ["api-rede-social-production.up.railway.app", "0.0.0.0", "localhost"]
...
ROOT_URLCONF = "_social_network.urls"
...
WSGI_APPLICATION = "_social_network.wsgi.application"
